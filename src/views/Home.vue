    ...
    <el-row class="home" :gutter="20">
        <el-col :span="8" style="margin-top:20px">
            <el-card shadow="hover" >
                <div class="user">
                    ...
                    <div class="user-info"> 
                        <p class="user-info-fufu">fufu</p>
                        <p class="user-info-p">世界第一公主殿下</p>
                    </div>
                </div>
                <div class="login-info">
                    <p>上次登录时间：<span>2025-05-07</span></p>
                    <p>上次登录的地点：<span>新乡</span></p>
                </div>
            </el-card>
        ...
        <el-col :span="16" style="margin-top: 20px;">
            ...
            <el-card class="top-echart" shadow="hover">
                <div ref="echart" style="height:240px">
                </div>
            </el-card>
            <div class="graph">
                <el-card shadow="hover">
